...
class Overload_by_class(object) :
    ...
    def __call__(self, function):
        ...
        # x is a type or a string representing a type, result of lambda will be a string in all case representing a type 
        ...
        def wrapped_function(*args_function):
            ...
            if function_found is None:
                raise TypeError("OverloadByClass : wrapped_function : no match")
